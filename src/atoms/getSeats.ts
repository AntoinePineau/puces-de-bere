...
export async function getSeats():Promise<Seat[]> {
  ...
  xy = addSeat(seats, `R46`, true, false, xyR37.x-space*9-seatHeight/2, xyR37.y-seatWidth-1, descSansInterieur, prixSansInterieur, existingSeatIds);
  var xyR46 = xy;
  for(var i=45;i>=40;i--) { 
    xy = addSeat(seats, `R${i}`, true, false, xy.x, xy.y-seatWidth-1, descSansInterieur, prixSansInterieur, existingSeatIds);
  }
  ...
  xy.x = xy.x-4*seatWidth-3-space*5;
  for(var i=54;i>=51;i--) { 
