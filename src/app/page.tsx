...
export default function Home() {
  ...
  return (
    <div className="mx-2 max-w-[1024px] pb-4">
      ...
      <ul>
        <li>Soit directement en ligne via ce site: <Link href="/reservation" className="block sm:inline mt-4 bg-green-500 text-white ml-4 px-4 py-2 rounded hover:bg-green-600 transition-colors items-center justify-center">Je veux réserver mes emplacements</Link></li>
